...
The purpose of this sample project is to demonstrate how a web developer, using **Auth0**, can add the identity provider **netID** as an option for their end users to signup and login to their web application.
